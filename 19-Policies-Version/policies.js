var leadershipPolicies = [
  ...
  {
    "policyDescription": "The city has an overview of all existing local and regional plans and develops and aligns its resilience action plans taking them into consideration. For instance, the city will need to adopt urban planning and building design strategies that allow them to increase their abilities to better respond and adapt to the economic, social, and physical challenges connecting each strategy to regional plans.",
    "policyText": "Align, integrate and connect the resilience action plan with regional plans",
    "policyCode": "L1M2",
    "Dimension": "Leadership",
    "dimension": "leadership",
    "stage": "MODERATE",
  ...
  {
    "policyDescription": "The city has in hand an overview of all existing local and regional plans and develops and aligns its resilience action plans taking them into consideration. For instance, the city will need to adopt urban planning and building design strategies that allow them to increase their abilities to better respond and adapt to the economic, social, and physical challenges connecting each strategy to regional and national plans.",
    "policyText": "Align, integrate and connect the resilience action plan with national plans",
    "policyCode": "L1A1",
    "Dimension": "Leadership",
    "dimension": "leadership",
    "stage": "ADVANCED",
  ...
  {
    "policyDescription": "The city conducts certification processes for assessing the activities of a city with regard to the fulfillment of existing international standards related to resilience. A standard is a documented definition or rule approved and monitored from compliance by the local authority as a minimum acceptable benchmark of resilience. The achievement of these standards demonstrates the concern and formal commitment of the city with respect to building city resilience.",
    "policyText": "Conduct certification processes to achieve the conformity with existing standards",
    "policyCode": "L2A2",
    "Dimension": "Leadership",
    "dimension": "leadership",
    "stage": "ADVANCED",
  ...
  {
    "policyDescription": "A set of indicators are identified and used to monitor and assess the level of implementation of the resilience action plan. These indicators can be measured quantitatively or qualitatively, and provide useful information of the deployment of resources and the evolution of the policies included in the resilience action plan.",
    "policyText": "Develop leading indicators for assessing the performance of the resilience action plan",
    "policyCode": "L4A2",
    "Dimension": "Leadership",
    "dimension": "leadership",
    "stage": "ADVANCED",
...
var preparednessPolicies = [
  {
    ...
    "policyText": "Asses and manage a full range of risks",
    "policyCode": "P1S1",
  ...
  {
    "policyDescription": "Engaging all relevant stakeholders in coordination of risk policies/strategies and continuous learning about the risk landscape at city/regional and European level though the use of RSQ.",
    "policyText": "Engage a wide range of relevant stakeholders in risk management process",
    "policyCode": "P1T1",
    "Dimension": "Preparedness",
    "dimension": "preparedness",
    "stage": "VERTEBRATE",
