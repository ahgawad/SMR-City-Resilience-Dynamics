var leadershipPolicies = [
  ...
  {
    "policyDescription": "The resilience department or committee will be formed by committed staff that will steer and coordinate the city’s resilience action plan.",
...
var preparednessPolicies = [
  ...
  {
    "policyDescription": "Scenarios are used to analyze the cascading effects, long term ramifications of shocks and unintended consequences of the implemented policies. These scenarios are evaluated regularly and the identified ‘lessons learned’ are documented and integrated within the resilience action plan.",
...
var cooperationPolicies = [
  ...
  {
    "policyDescription": "A public platform such as websites and databases needs to be set up in order for stakeholders to share experiences, lessons identified and best practices and learn from each other’s experiences.",
